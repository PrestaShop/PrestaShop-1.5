...
function alter_price_columns()
{
	...
	foreach($sql as $query){
		DB::getInstance()->execute('ALTER TABLE `'._DB_PREFIX_.$query['table'].'` CHANGE `'.$query['column'].'`  `'.$query['column'].'` DECIMAL( 25, 10 ) NOT NULL DEFAULT  \'0.00\'');		
	}
}
